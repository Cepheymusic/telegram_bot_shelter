...
//, nativeQuery = true
    @Query(value = "select * from reports max(report_date) group by id_users, resolution = 'PROBATION'")
    List<Report> dailyReport();//все столбцы сгруппированные по айди и статусу и с максимальной датой
